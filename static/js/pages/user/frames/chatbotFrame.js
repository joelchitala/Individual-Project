...
import { user, user_id, user_valid } from "../index.js";
...
const search_chatbots_collection_url = '/search/collection/chatbots'
...
const updateChatbotPage = new Page("update-chatbot-page",["update chatbot"],[updateChatbotView])
...
chatbotView.template((self,parent)=>{
    ...
    const id = JSON.stringify({"user_id":user_id}) 
    let chatbots = xml_req("POST",search_chatbots_collection_url,id,true)
...
createChatbotView.template((self,parent)=>{
    ...
    const str = `
        ...
        <input-tag label="Select User" name="user_id" type="number" value="${user_id}" hidden></input-tag>
